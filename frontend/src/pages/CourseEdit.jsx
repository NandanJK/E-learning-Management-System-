...
const CourseEdit = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`https://e-learning-management-system-j748.onrender.com/api/courses/${id}`, formData, {
        ...
        <div className="max-w-2xl mx-auto px-4 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    ...
                    {formData.thumbnail && (
                        <div className="mb-2">
                            <img src={`https://e-learning-management-system-j748.onrender.com${formData.thumbnail}`} alt="Current Thumbnail" className="w-32 h-20 object-cover rounded" />
                        </div>
                    )}
                    <input
                        type="file"
